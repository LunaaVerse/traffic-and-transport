...
<head>
  ...
  <style>
    ...
    * {
    ...
    .dropdown-toggle:hover i, .dropdown-toggle.active i {
      color: var(--primary);
      transform: scale(1.1);
    }
...
<body>
    ...
    <div class="main-content">
      ...
      <div class="dashboard-header">
        ...
        <div class="header-actions">
          <div class="user-info text-end">
            <span class="fw-medium"><?= htmlspecialchars($user_profile['full_name'] ?? 'Admin') ?></span>
            <span class="text-muted d-block small"><?= htmlspecialchars($user_profile['role'] ?? 'Administrator') ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-content">
            <h3><?= count(array_filter($reports, function($r) { return $r['status'] === 'Approved'; })) ?></h3>
        ...
        <div class="stat-card">
          ...
          <div class="stat-content">
            <h3><?= count(array_filter($reports, function($r) { return $r['status'] === 'Rejected'; })) ?></h3>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <?php if ($report['status'] === 'Pending'): ?>
                          <a href="?action=approve&id=<?= $report['id'] ?>" class="btn btn-sm btn-action btn-approve" onclick="return confirmAction('approve', <?= $report['id'] ?>)">
                            <i class='bx bx-check'></i> Approve
                          </a>
                          <a href="?action=reject&id=<?= $report['id'] ?>" class="btn btn-sm btn-action btn-reject" onclick="return confirmAction('reject', <?= $report['id'] ?>)">
                            <i class='bx bx-x'></i> Reject
                          </a>
                        <?php endif; ?>
                        
                        <a href="?action=delete&id=<?= $report['id'] ?>" class="btn btn-sm btn-action btn-delete" onclick="return confirmAction('delete', <?= $report['id'] ?>)">
  ...
  <script>
    ...
    // SweetAlert confirmation for actions
