...
if (isset($_POST['add']) && $_SESSION['user_role'] === 'citizen') {
    ...
    if (empty($location) || empty($volume) || empty($district) || empty($barangay)) {
        ...
        try {
            ...
            $stmt = $pdo_tm->prepare("INSERT INTO traffic_logs (employee_id, location, volume, remarks, district, barangay, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)");
$stmt->execute([$user_id, $location, $volume, $remarks, $district, $barangay, $user_id]);
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="../road_conditions.php" class="sidebar-link">
                    <i class='bx bx-road'></i>
                    <span class="text">Road Conditions</span>
                </a>
